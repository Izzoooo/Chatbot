...
class ExamAPI extends Page
{
    ...
    protected function getViewData():array
    {
        ...
        if (isset($this->Question)) {
            $this->Question = $this->_database->real_escape_string($this->Question);
        }


        $sql = "SELECT answer  FROM HDA_Chatbot.interaction WHERE question = '$this->Question'";
    ...
    protected function generateView():void
    {
       ...
       //$this->generatePageHeader('to do: change headline'); //to do: set optional parameters
        ...
        $aktualisieren = json_encode($data);
        echo $aktualisieren;
